...
import createInfoItem from 'src/dal/item/info/create'
...
const createInfo: Required<MutationResolvers>['createInfo'] = async (
  _,
  args,
  context
) => {
  ...
  if (!item.info) {
    ...
    throw new GraphQLError('Info creation failed')
  }
