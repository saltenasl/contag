...
import createTaskItem from 'src/dal/item/task/create'
...
const createTask: Required<MutationResolvers>['createTask'] = async (
  _,
  args,
  context
) => {
  ...
  if (!item.task) {
    ...
    throw new GraphQLError('Task creation failed')
  }
